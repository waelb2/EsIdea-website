...
const LandingPageFirstSection = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center my-16 bg-[length:105%_65%] bg-no-repeat bg-right-bottom' style={{backgroundImage: `url(${BackgroundImage})`}}>
      ...
      {/* Main title */}
      <p className='font-extrabold text-6xl'>Collaborative </p>
      <p className='font-extrabold text-6xl mb-14'>Idea Collection </p>
      {/* Button for continuing with Google */}
      <div className='mt-12 p-5 bg-white rounded-full'>
        <button className='flex justify-center items-center bg-skyBlue shadow-[0_6px_16px_0px_rgba(0,0,0,0.3)] px-10 py-3 rounded-full'>
