...
const UserIdea = ({ ideas, onDelete }) => {
  ...
  return (
     ...
     {(user.email === userT.email) && (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 cursor-pointer" onClick={() => onDelete(ideas[0].ideaId)}>
