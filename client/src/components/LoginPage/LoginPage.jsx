  ...
  return (
    ...
    <div className="bg-white w-full overflow-hidden min-h-screen flex flex-col">
      ...
      <div className='sm:px-16 px-6 flex justify-center items-center h-full flex-grow'>
          <div className='xl:max-w-[80rem] w-full h-full flex md:flex-row md:justify-around flex-col-reverse items-center'>
              <img className='w-[28.125rem] h-[28.125rem] object-cover mt-3 md:mt-0 p-6 ' src={loginPic} alt="Brain" />
              <div className='shadow-md rounded-lg p-7  max-w-[28.125rem] w-full mt-5 md:mt-0 border-2 border-[rgba(0,0,0,0.1)]'>
                <div className='mb-4'>
                  <h4 className='text-2xl font-medium'>Welcome to</h4>
                  <h1 className='text-skyBlue font-black text-2xl'>ESIdea</h1>
                </div>
                <button onClick={login}  className='flex gap-2 items-center justify-center rounded-xl shadow-[0_1px_6px_rgb(0,0,0,0.2)] w-full py-3 mb-5'>
                  <img className='w-7 h-7' src={google} alt="Google_Icon" />
